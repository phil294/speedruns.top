...
<? endif; ?>
<form method="post">
	<p><label for="name">game name</label> <input type="text" id="name" name="name" maxlength="100" minlength="3" required value="<?= e($_POST['name'] ?? '') ?>"></p>
	<p><label for="website">website/wiki</label> <input type="url" id="website" name="website" maxlength="300" minlength="3" required value="<?= e($_POST['website'] ?? '') ?>"></p>
